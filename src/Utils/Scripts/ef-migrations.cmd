...
dotnet ef --startup-project ../BlazorBoilerplate.Storage/ migrations add CreateLocalizationDb -c LocalizationDbContext --verbose --no-build --configuration Debug -o "Migrations/LocalizationDb"
